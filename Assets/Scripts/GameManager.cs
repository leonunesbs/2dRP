...
public class GameManager : MonoBehaviour
{
  ...
  {
    // Formula: (endurance * 10) + (level * 4) + 10
    Int32 result = (entity.endurance * 10) + (entity.level * 4) + 80;
  ...
  public Int32 CalculateMana(Entity entity)
  {
    ...
    Int32 result = (entity.intelligence * 10) + (entity.level * 4) + 50;
  ...
  {
    // Formula: (intelligence * 10) + (level * 4) + 5
    Int32 result = (entity.endurance + entity.willPower) + (entity.level * 2) + 5;
